...
function updateCartTotal() {
    ...
    for (var i = 0; i < cartRows.length; i++) {
        ...
        var tits = cartRow.getElementsByClassName('cart-item-title')[0].innerText;
        ...
        kafinye.push(" Item: " +tits + " price per item is " +price 
                +" ordered " +quantity +" kgs" + total)
        ...
        var vitu = i + 1;
        document.getElementsByClassName('cart-total-price')[0].innerText = vitu;

        
    }

    console.log(kafinye.length);

   
    
    
    document.getElementsByClassName('cart-total-prices')[0].innerText = "Ksh: " + total
    ...
    bangRowContents = `<textarea name="goods" class="cart-price cart-column"  hidden>${kafinye}
    </textarea><span>`
